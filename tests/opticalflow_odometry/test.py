...
from utils.helper_functions import json_reader, scale_intrinsic_matrix
...
K = scale_intrinsic_matrix(intrinsic_matrix, calib_resolution, sc.YOUTUBE_TLWH_SMALL[-2:])
focal = K[0, 0]
pp = (K[0, 2], K[1, 2])
